...
export default function Profile({ db, state, user, onLogin, onNavigate }) {
  ...
  // Same components Results uses, so the report card and the browsable
  // profile can't describe the same person differently.
  const situations = buildSituations(scores, db)
  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <SituationJumpLinks situations={jumpLinks} idPrefix="profile" heading="What would you like to know?" />

      {/* The situational picture — the substance of the profile. */}
      <SituationSections situations={situations} idPrefix="profile" />
      <SituationSections situations={relational} idPrefix="profile" />

      <FrictionSection opposite={opposite} lowEnergy={lowEnergy} id="profile-friction" />
